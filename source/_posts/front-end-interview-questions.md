...
由于目前前端的东西全都是自己自学然后实践得来的，并不系统，写这篇blog的直接目的是为了记录前端面试可能会遇到的问题，间接目的主要是能够让自己开始系统地学习这些知识，为更长远的发展奠定基础。问题是转来的[1](https://github.com/markyun/My-blog/blob/master/Front-end-Developer-Questions/Question/README.md)，答案是用自己的理解叙述的。
...
- Doctype作用？严格模式与混杂模式如何区分？它们有何意义?
        ...
        2.
		3. 严格模式是以该浏览器的最高标准运行；混杂模式（兼容模式）是以宽松的向后兼容的模式运行，模拟老式浏览器的行为使页面得以正常显示。
